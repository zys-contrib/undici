...
function abortFetch (p, request, responseObject) {
  ...
  if (request.body !== null) {
    cancelIfReadable(request.body, error)
  }
...
function fetching ({ request, processResponse, processResponseDone }) {
  ...
  // TODO: What is a "byte sequence?" What is "body" here?
  if (
    request.body &&
    request.body.source &&
    (typeof request.body.source === 'string' ||
      util.isBuffer(request.body.source))
  ) {
...
function cancelIfReadable (body, reason) {
  try {
    if (body.stream) {
